...
function About() {
  return (
    <main className="about-main">
      ...
      <div className="scroll-down-btn" onClick={() => document.querySelector('#section2').scrollIntoView({ behavior: 'smooth' })}>
        <span>ScrollDown<br />버튼</span>
      </div>
      </section>
      ...
      <div className="scroll-down-btn" onClick={() => document.querySelector('#section3').scrollIntoView({ behavior: 'smooth' })}>
        <span>ScrollDown<br />버튼</span>
      </div>
      </section>
      ...
      <div className="scroll-down-btn" onClick={() => document.querySelector('#section4').scrollIntoView({ behavior: 'smooth' })}>
        <span>ScrollDown<br />버튼</span>
      </div>
      </section>
